...
class ReIterateTutorial2 extends StatefulWidget {
  @override
  _ReIterateTutorial2State createState() => _ReIterateTutorial2State();
}
...
class _ReIterateTutorial2State extends State<ReIterateTutorial2> {
  ...
  void initState() {
    ...
    flickManager = FlickManager(
      ...
      VideoPlayerController.network("https://admin.dezyit.com/mobileapp/mailerimages/DezyVideos/reiterate.mp4"),
    );
  }
  @override
  void dispose() {
