...
class ShadowingTutorial2 extends StatefulWidget {
  @override
  _ShadowingTutorial2State createState() => _ShadowingTutorial2State();
}

class _ShadowingTutorial2State extends State<ShadowingTutorial2> {
  ...
  Widget buildImage1Container(BuildContext context){
    return Center(
      child: Container(
          width: 233.56,
          height: 151.28,
          child: Image.asset("assets/images/shadowingtut.png")),
    );
  }
