...
class IvsFTutorial2 extends StatefulWidget {
  @override
  _IvsFTutorial2State createState() => _IvsFTutorial2State();
}

class _IvsFTutorial2State extends State<IvsFTutorial2> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network(
        'https://dezyit.ml/mobileapp/mailerimages/DezyVideos/ivsf.mp4')
      ..initialize().then((_) {
    ...
    flickManager = FlickManager(
      ...
      VideoPlayerController.network("https://dezyit.ml/mobileapp/mailerimages/DezyVideos/ivsf.mp4"),
    );
  }
  @override
  void dispose() {
