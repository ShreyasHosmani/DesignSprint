...
import 'package:design_sprint/Screens/Inside%20Screens/Function%20Screens/User%20Testing/Mapping%20Insights/insights_form_screen.dart';
...
class MappingInsightsTutorial2 extends StatefulWidget {
  @override
  _MappingInsightsTutorial2State createState() => _MappingInsightsTutorial2State();
}

class _MappingInsightsTutorial2State extends State<MappingInsightsTutorial2> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network(
        'https://admin.dezyit.com/mobileapp/mailerimages/DezyVideos/mappinginsights.mp4')
      ..initialize().then((_) {
    ...
    flickManager = FlickManager(
      ...
      VideoPlayerController.network("https://admin.dezyit.com/mobileapp/mailerimages/DezyVideos/mappinginsights.mp4"),
    );
  }
  @override
  void dispose() {
  ...
  Widget buildInfoText1(BuildContext context){
    return Padding(
      ...
      child: Text("Mapping Insights can take place in person or via video conferencing. In a design sprint, they are usually 30-45-minute casual conversations. In the interview room, the user is introduced to the prototype and is allowed to interact with it while their reactions are monitored.",
        style: GoogleFonts.nunitoSans(
          textStyle: TextStyle(
            fontSize: 16,
          ),
  ...
  Widget buildImage1Container(BuildContext context){
    return Center(
      child: Container(
          width: 233.56,
          height: 151.28,
          child: Image.asset("assets/images/mitut.png")),
    );
  }
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (c, a1, a2) => InsightsForm(),
