...
class PrototypingTutorial2 extends StatefulWidget {
  @override
  _PrototypingTutorial2State createState() => _PrototypingTutorial2State();
}

class _PrototypingTutorial2State extends State<PrototypingTutorial2> {
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (c, a1, a2) => UploadPrototypeImagesPageViewBuilder(),
