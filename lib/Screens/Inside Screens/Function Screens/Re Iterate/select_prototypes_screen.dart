...
class _SelectPrototypesState extends State<SelectPrototypes> {
  ...
  void initState() {
    super.initState();
    reIterateApiProvider.getPrototypeImagesPainPointWise(context).whenComplete((){
  ...
  Widget buildName3Widget(BuildContext context){
    ...
    return Center(
      child: Text(reiterate.selectPrototypeHint1,
  ...
  Widget buildPrototypeListViewBuilder(BuildContext context){
    return reiterate.prototypeAllImagesList == null ? Container() : ListView.builder(
      physics: ScrollPhysics(),
      shrinkWrap: true,
      scrollDirection: Axis.vertical,
      itemCount: reiterate.prototypeAllImagesList == null ? 0 : reiterate.prototypeAllImagesList.length,
      itemBuilder: (context, i) => Column(
        ...
        children: [
          Stack(
            children: [
              reiterate.prototypeAllImagesList == null ? Container(
                height: 161,
                width: 302,
                decoration: BoxDecoration(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: NetworkImage(globals.urlSignUp+reiterate.prototypeAllImagesList[i]),
                      fit: BoxFit.cover
                  ),
                ),
              ),
            ...
            onTap: (){
              setState(() {
                ...
                if(boolSelectedList[i] == false){
                  setState(() {
                    counter--;
                    reiterate.selectedPrototypeIdForReiterateModule = reiterate.prototypeAllImagesIdsList[i];
