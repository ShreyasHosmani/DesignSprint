...
class _RoadMapSprintWiseState extends State<RoadMapSprintWise> {
  ...
  void initState() {
    ...
    reIterateApiProvider.getRoadMapDataNotes2(context).whenComplete((){
      Future.delayed(const Duration(seconds: 3), () {
        setState(() {
          reIterateApiProvider.getRoadMapDataTasksAndTimeLines2(context).whenComplete((){
  ...
  Widget buildRoadMapListViewBuilder(BuildContext context){
    return reiterate.allPrototypeNotes == null || reiterate.allPrototypeDueDates == null || reiterate.prototypeAllImagesListOfStatusTwo2 == null ? Container() : Container(
      width: 250,
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(globals.urlSignUp+reiterate.prototypeAllImagesListOfStatusTwo2[i]),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
