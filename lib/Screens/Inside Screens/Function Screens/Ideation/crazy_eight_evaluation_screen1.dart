...
Timer _timer;
int _start = 480;
String startTimings = "Start";

class GetPainPointsOfStatusTwoPageViewBuilder extends StatefulWidget {
  @override
  _GetPainPointsOfStatusTwoPageViewBuilderState createState() =>
      _GetPainPointsOfStatusTwoPageViewBuilderState();
}

class _GetPainPointsOfStatusTwoPageViewBuilderState
    extends State<GetPainPointsOfStatusTwoPageViewBuilder> {
  ...
  Future<String> getPainPointsOfStatusTwo(context) async {
    ...
    http.post(url, body: {
      ...
      ideation.responseArrayGetPainPointsOfStatusTwo =
          jsonDecode(response.body);
      print(ideation.responseArrayGetPainPointsOfStatusTwo);

      ideation.responseArrayGetPainPointsOfStatusTwoMsg =
          ideation.responseArrayGetPainPointsOfStatusTwo['message'].toString();
      print(ideation.responseArrayGetPainPointsOfStatusTwoMsg);
      if (statusCode == 200) {
        if (ideation.responseArrayGetPainPointsOfStatusTwoMsg == "Data Found") {
          setState(() {
            ideation.painPointsOfStatus2List = List.generate(
                ideation.responseArrayGetPainPointsOfStatusTwo['data'].length,
                (index) => ideation
                    .responseArrayGetPainPointsOfStatusTwo['data'][index]
                        ['ppName']
                    .toString());
            ideation.painPointsIdsOfStatus2List = List.generate(
                ideation.responseArrayGetPainPointsOfStatusTwo['data'].length,
                (index) => ideation
                    .responseArrayGetPainPointsOfStatusTwo['data'][index]
                        ['ppID']
          ...
          print((ideation.pageIndex + 1) /
              ideation.painPointsOfStatus2List.length);
        } else {
          setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ideation.painPointsOfStatus2List == null
          ? Center(
              child: CircularProgressIndicator(),
            )
          : PageView.builder(
              physics: new NeverScrollableScrollPhysics(),
              itemCount: ideation.painPointsOfStatus2List == null
                  ? 0
                  : ideation.painPointsOfStatus2List.length,
...
class _CrazyEightEvaluation1State extends State<CrazyEightEvaluation1> {
  ...
  final CountdownController _controllerNew =
            ...
            children: [
              ...
              SizedBox(
                ...
                build: (_, double time) => Text(
                  // time.toString(),
                  (getParsedTime((time ~/ 60).toString()) +
                          " : " +
                          getParsedTime((time % 60).toString()))
                      .split(".")
                      .first,
              ...
              SizedBox(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap: () {
                      setState(() {
                        if(startTimings=="Start"){

                          startTimings="Stop";
                          _controllerNew.start();

                        }else if(startTimings=="Stop"){
                          startTimings="Resume";
                          _controllerNew.pause();
                        }else if(startTimings=="Resume"){
                          startTimings="Stop";
                          _controllerNew.resume();
                        }
                      });
    ...
    AlertDialog alert = AlertDialog(
      ...
      title: Column(
        ...
        children: [
          ...
          Text(ideation.timeUp,
              style: GoogleFonts.nunitoSans(
                textStyle: TextStyle(
                    fontSize: 16, letterSpacing: 1, color: Color(0xff787cd1)),
              )),
        ],
      ),
      content: Padding(
