...
class UploadIdeaImagePageViewBuilder extends StatefulWidget {
  @override
  _UploadIdeaImagePageViewBuilderState createState() =>
      _UploadIdeaImagePageViewBuilderState();
}
...
class _UploadIdea1State extends State<UploadIdea1> {
  ...
  Future<String> getIdeaImages(context) async {
    ...
    http.post(url, body: {
      ...
      ideation.responseArrayGetIdeaImagesMsg =
          ideation.responseArrayGetIdeaImages['message'].toString();
      ...
      if (ideation.responseArrayGetIdeaImagesMsg == "Painpoint Data Found") {
        setState(() {
          ...
          ideation.ideaImagesPainPointWiseList = List.generate(
              ideation.responseArrayGetIdeaImages['data'].length,
              (i) =>
                  "https://admin.dezyit.com/mobileapp/" +
                  ideation.responseArrayGetIdeaImages['data'][i]['iiImgpath']
                      .toString()
                      .substring(6));
          _isVisible = true;
        });
        ...
        if (responseArrayGetSprintStatusesMsg == "Data Found") {
          ...
          if (teamMemberStatuses.toList().contains('0')) {
            Fluttertoast.showToast(
              msg: 'Please wait until rest of the team uploads idea images!',
  ...
  void initState() {
    ...
    setState(() {
      ...
      ideation.selectedPainPointIdForUploadIdeaImage =
          ideation.painPointsIdsOfStatus2List[ideation.pageIndexIdea];
      print(ideation.selectedPainPointIdForUploadIdeaImage);
    ...
    return Padding(
      ...
      child: Center(
        child: LinearPercentIndicator(
          lineHeight: 10,
          percent: (ideation.pageIndexIdea + 1) /
              ideation.painPointsOfStatus2List.length,
  ...
  Widget buildNumberIndicator(BuildContext context) {
    return Container(
      ...
      child: Center(
        child: Text(
          (ideation.pageIndexIdea + 1).toString(),
          style: GoogleFonts.nunitoSans(
            color: Colors.white,
            fontSize: 14,
          ),
    ...
    return ideation.ideaImagesPainPointWiseList == null
        ...
        : Container(
            ...
            child: ListView.builder(
              ...
              itemCount: ideation.ideaImagesPainPointWiseList == null
                  ? 0
                  : ideation.ideaImagesPainPointWiseList.length,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(
                                    ideation.ideaImagesPainPointWiseList[i]),
                                fit: BoxFit.cover,
                                scale: 5)),
                      )),
                ),
        ...
        ? GestureDetector(
            onTap: () {
              if (ideation.ideaImagesPainPointWiseList == null) {
                Fluttertoast.showToast(
                  msg: "You must upload atleast one image",
                  backgroundColor: Colors.black,
                  textColor: Colors.white,
                );
              } else {
            ...
            getSprintsStatusesOfTeam2(context);*/
                  ...
                  setState(() {
                    ideation.pageIndexIdea = ideation.pageIndexIdea + 1;
                  });
