...
class IdeationInsideSections2 extends StatefulWidget {
  @override
  _IdeationInsideSections2State createState() => _IdeationInsideSections2State();
}

class _IdeationInsideSections2State extends State<IdeationInsideSections2> {
          ...
          child: Stack(
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(bottom: 33, left: 21),
                  child: Image.asset("assets/images/crazy8.png", scale: 1,),
                ),
              ),
              Padding(
          ...
          child: Stack(
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(bottom: 33, left: 21),
                  child: Image.asset("assets/images/ivsfanalysis.png", scale: 1,),
                ),
              ),
              Padding(
