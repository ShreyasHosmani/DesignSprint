...
class IdeationInsideSections extends StatefulWidget {
  @override
  _IdeationInsideSectionsState createState() => _IdeationInsideSectionsState();
}

class _IdeationInsideSectionsState extends State<IdeationInsideSections> {
