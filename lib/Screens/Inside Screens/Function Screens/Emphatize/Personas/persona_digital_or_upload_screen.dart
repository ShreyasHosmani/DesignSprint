...
class CreateOrDownloadPersona extends StatefulWidget {
  @override
  _CreateOrDownloadPersonaState createState() => _CreateOrDownloadPersonaState();
}
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (c, a1, a2) => UploadPersona(),
