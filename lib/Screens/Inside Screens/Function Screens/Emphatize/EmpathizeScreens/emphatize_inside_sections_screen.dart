...
class EmphatizeInsideSections extends StatefulWidget {
  @override
  _EmphatizeInsideSectionsState createState() => _EmphatizeInsideSectionsState();
}

class _EmphatizeInsideSectionsState extends State<EmphatizeInsideSections> {
