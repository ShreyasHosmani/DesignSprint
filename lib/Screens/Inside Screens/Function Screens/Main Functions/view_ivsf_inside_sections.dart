...
import 'package:design_sprint/Screens/Inside%20Screens/Function%20Screens/Main%20Functions/view_ratings_of_impact_and_feasibility.dart';
import 'package:design_sprint/Screens/Inside%20Screens/Function%20Screens/Main%20Functions/view_selected_ideas.dart';
...
class ViewIvsFInsideSections extends StatefulWidget {
  @override
  _ViewIvsFInsideSectionsState createState() => _ViewIvsFInsideSectionsState();
}

class _ViewIvsFInsideSectionsState extends State<ViewIvsFInsideSections> {
  @override
  void initState() {
  ...
  Widget buildRatingsCard(BuildContext context){
    return Center(
      child: GestureDetector(
        onTap: (){
          Navigator.push(
            context,
            PageRouteBuilder(
              pageBuilder: (c, a1, a2) => ViewRatingsOfImpactAndFeasibility(),
  ...
  Widget buildSelectedIdeasCard(BuildContext context){
    return Center(
      child: GestureDetector(
        onTap: (){
          Navigator.push(
            context,
            PageRouteBuilder(
              pageBuilder: (c, a1, a2) => ViewSelectedIdeas(),
              transitionsBuilder: (c, anim, a2, child) => FadeTransition(opacity: anim, child: child),
              transitionDuration: Duration(milliseconds: 300),
            ),
          );
