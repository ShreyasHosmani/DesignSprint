...
class EmphatizeSections extends StatefulWidget {
  @override
  _EmphatizeSectionsState createState() => _EmphatizeSectionsState();
}

class _EmphatizeSectionsState extends State<EmphatizeSections> {
