...
class EmphatizeSections4 extends StatefulWidget {
  @override
  _EmphatizeSections4State createState() => _EmphatizeSections4State();
}

class _EmphatizeSections4State extends State<EmphatizeSections4> {
