...
class ViewRoadMap extends StatefulWidget {
  @override
  _ViewRoadMapState createState() => _ViewRoadMapState();
}

class _ViewRoadMapState extends State<ViewRoadMap> {
  ...
  Widget buildRoadMapListViewBuilder(BuildContext context){
    return
      //reiterate.uploadedTaskList == null ? Container() :
      Container(
      width: 250,
      child: ListView.builder(
        ...
        itemCount: 4,//reiterate.uploadedTaskList == null ? 0 : reiterate.uploadedTaskList.length,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: 2,//i == 0 ? reiterate.roadMapTaskList.length : i == 1 ? reiterate.roadMapTaskList1.length : reiterate.roadMapTaskList2.length,
