...
class MappingInsightsTutorial extends StatefulWidget {
  @override
  _MappingInsightsTutorialState createState() =>
      _MappingInsightsTutorialState();
}
...
class _MappingInsightsTutorialState extends State<MappingInsightsTutorial> {
  ...
  Widget buildName2Widget(BuildContext context) {
    return Center(
      child: Text(
        userTesting.sectionsScreenCard3,
        style: GoogleFonts.nunitoSans(
            textStyle: TextStyle(
  ...
  Widget buildInfoText1(BuildContext context) {
    return Padding(
      ...
      child: Text(
        "Mapping Insights can take place in person or via video conferencing. In a design sprint, they are usually 30-45-minute casual conversations. In the interview room, the user is introduced to the prototype and is allowed to interact with it while their reactions are monitored.",
        style: GoogleFonts.nunitoSans(
          textStyle: TextStyle(
            fontSize: 16,
          ),
