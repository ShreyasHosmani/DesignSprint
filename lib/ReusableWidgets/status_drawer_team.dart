...
class StatusDrawerTeam extends StatefulWidget {
  @override
  _StatusDrawerTeamState createState() => _StatusDrawerTeamState();
}

class _StatusDrawerTeamState extends State<StatusDrawerTeam> {
  @override
