...
class StatusDrawerSprintGoal extends StatefulWidget {
  @override
  _StatusDrawerSprintGoalState createState() => _StatusDrawerSprintGoalState();
}

class _StatusDrawerSprintGoalState extends State<StatusDrawerSprintGoal> {
  @override
