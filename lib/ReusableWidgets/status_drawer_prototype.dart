...
class StatusDrawerPrototyping extends StatefulWidget {
  @override
  _StatusDrawerPrototypingState createState() => _StatusDrawerPrototypingState();
}

class _StatusDrawerPrototypingState extends State<StatusDrawerPrototyping> {
  @override
